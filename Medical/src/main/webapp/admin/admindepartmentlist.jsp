        ...
        <div class="layer-wrapper">
            <div class="row">
        		...
        		<div style = "margin: 0 0 0 0;" class="theme-material-card">
                            ...
                            <a href ="<%=request.getContextPath()%>/adminShowAllDepartment"><button class="mdl-button mdl-js-button mdl-button--colored mdl-js-ripple-effect button button-primary button-sm m-1">Xem toàn bộ khoa</button></a>
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">${item.intro }</td>
                                         <td class="text-center">
                                            <a  href="<%=request.getContextPath()%>/editDepartment?id=${item.idDepartment}" data-toggle="tooltip" data-placement="top" title="Sửa"><i class="fa fa-pencil color-dark"></i></a>
