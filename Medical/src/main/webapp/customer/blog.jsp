                ...
                <div class="col-lg-8 text-center">
                    <div class="sidebar">
                        ...
                        <div class="blog-post">
                            ...
                            <p style="white-space: pre-line;" class="paragraph-medium paragraph-black">${blogInfo.paragraph1}</p>
                            <div class="theme-quote">
                                <i class="fa fa-quote-left"></i> ${blogInfo.quote}
                            </div>
                            <p style="white-space: pre-line;" class="paragraph-medium paragraph-black">${blogInfo.paragraph2}</p>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <p style="white-space: pre-line;" class="paragraph-medium paragraph-black">${blogInfo.paragraph3}"</p>
                        </div>
