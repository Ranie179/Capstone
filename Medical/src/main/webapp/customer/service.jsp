                ...
                <div class="col-lg-8 text-center">
                    ...
                    <input style = "display:none;" type = "text" id = "id" name = "id" value = "${serviceInfo.id }"> 
                        ...
                        <div class="service-post">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p style="white-space: pre-line;" class="paragraph-medium paragraph-black text-justify"><c:out value="${serviceInfo.description1}" /></p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <p></p>
                            <p style="white-space: pre-line;" class="paragraph-medium paragraph-black text-justify"><c:out value="${serviceInfo.description2}" /></p>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="theme-img theme-img-scalerotate">
                            ...
                            <p></p>
                            <p style="white-space: pre-line;" class="paragraph-medium paragraph-black text-justify"><c:out value="${serviceInfo.description3}" /></p>
