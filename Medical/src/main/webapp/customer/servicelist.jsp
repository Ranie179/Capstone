                ...
                <div class="col-lg-8">
                    <div class="theme-material-card">
                        <div class="theme-accordion-container">
                            ...
                            <div class="theme-accordion">
                                <div class="theme-accordion-hdr">
                                    <h4><i class="fa fa-flask"></i> Laboratory Services</h4>
                                    <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="theme-accordion-bdy">
                                    <div class="row service-accordian">
                                        <div class="col-sm-3 theme-accordian-img text-center">
                                            <img class="img-responsive img-thumbnail" src="uploads/service-4.jpg" alt="">
                                        </div>
                                        <div class="col-sm-9">
                                            <p class="paragraph-small paragraph-black">
                                                <i class="fa fa-flask theme-dropcap"></i>
                            ...
                            <div class="theme-accordion">
                                <div class="theme-accordion-hdr">
                                    <h4><i class="fa fa-certificate"></i> Mammography</h4>
                                    <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="theme-accordion-bdy">
                                    <div class="row service-accordian">
                                        <div class="col-sm-3 theme-accordian-img text-center">
                                            <img class="img-responsive img-thumbnail" src="uploads/service-5.jpg" alt="">
                                        </div>
                                        <div class="col-sm-9">
                                            <p class="paragraph-small paragraph-black">
                                                <i class="fa fa-certificate theme-dropcap"></i>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt voluptatum amet molestiae, sint consequatur, quam. Vero enim fugit provident labore qui, autem, cum numquam ipsa repudiandae asperiores saepe mollitia, voluptatibus! Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi.
                                            </p>
                                            <div class="pull-right">
                                                <a href="#" class="button-icon">
                            ...
                            <div class="theme-accordion">
                                <div class="theme-accordion-hdr">
                                    <h4><i class="fa fa-wheelchair-alt"></i> Skin Care</h4>
                                    <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="theme-accordion-bdy">
                                    <div class="row service-accordian">
                                        <div class="col-sm-3 theme-accordian-img text-center">
                                            <img class="img-responsive img-thumbnail" src="uploads/service-6.jpg" alt="">
                                        </div>
                                        <div class="col-sm-9">
                                            <p class="paragraph-small paragraph-black">
                                                <i class="fa fa-wheelchair-alt theme-dropcap"></i>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt voluptatum amet molestiae, sint consequatur, quam. Vero enim fugit provident labore qui, autem, cum numquam ipsa repudiandae asperiores saepe mollitia, voluptatibus! Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi.
                                            </p>
                                            <div class="pull-right">
                            ...
                            <div class="theme-accordion">
                                <div class="theme-accordion-hdr">
                                    <h4><i class="fa fa-h-square"></i> Dermatologist</h4>
                                    <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="theme-accordion-bdy">
                                    <div class="row service-accordian">
                                        <div class="col-sm-3 theme-accordian-img text-center">
                                            <img class="img-responsive img-thumbnail" src="uploads/service-7.jpg" alt="">
                                        </div>
                                        <div class="col-sm-9">
                                            <p class="paragraph-small paragraph-black">
                                                <i class="fa fa-h-square theme-dropcap"></i>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt voluptatum amet molestiae, sint consequatur, quam. Vero enim fugit provident labore qui, autem, cum numquam ipsa repudiandae asperiores saepe mollitia, voluptatibus! Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi.
                                            </p>
                                            <div class="pull-right">
                                                <a href="#" class="button-icon">
                            ...
                            <div class="theme-accordion">
                                <div class="theme-accordion-hdr">
                                    <h4><i class="fa fa-glass"></i> Anesthesiology</h4>
                                    <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="theme-accordion-bdy">
                                    <div class="row service-accordian">
                                        <div class="col-sm-3 theme-accordian-img text-center">
                                            <img class="img-responsive img-thumbnail" src="uploads/service-8.jpg" alt="">
                                        </div>
                                        <div class="col-sm-9">
                                            <p class="paragraph-small paragraph-black">
                                                <i class="fa fa-glass theme-dropcap"></i>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt voluptatum amet molestiae, sint consequatur, quam. Vero enim fugit provident labore qui, autem, cum numquam ipsa repudiandae asperiores saepe mollitia, voluptatibus! Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi.
                                            </p>
                                            <div class="pull-right">
                                                <a href="#" class="button-icon">
                            ...
                            <div class="theme-accordion">
                                <div class="theme-accordion-hdr">
                                    <h4><i class="fa fa-stethoscope"></i> Paediatrics</h4>
                                    <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="theme-accordion-bdy">
                                    <div class="row service-accordian">
                                        <div class="col-sm-3 theme-accordian-img text-center">
                                            <img class="img-responsive img-thumbnail" src="uploads/service-9.jpg" alt="">
                                        </div>
                                        <div class="col-sm-9">
                                            <p class="paragraph-small paragraph-black">
                                                <i class="fa fa-stethoscope theme-dropcap"></i>
                            ...
                            <div class="theme-accordion">
                                <div class="theme-accordion-hdr">
                                    <h4><i class="fa fa-eye"></i> Eye Care</h4>
                                    <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="theme-accordion-bdy">
                                    <div class="row service-accordian">
                            ...
                            <div class="theme-accordion">
                                <div class="theme-accordion-hdr">
                                    <h4><i class="fa fa-bullhorn"></i> Radiology Center</h4>
                                    <div class="theme-accordion-control"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="theme-accordion-bdy">
                                    <div class="row service-accordian">
